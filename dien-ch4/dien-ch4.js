...
let player = '<h1 class="text-h1">PLAYER 1</h1>'
for (let i = 0; i < game.length; i++) {
  player += `<div id="player-${game[i].name}-${game[i].id}" class="default-content" onclick="handleClick('player-${game[i].name}-${game[i].id}','${game[i].name}')"><img src="dien-ch4-assets/${game[i].image}" alt="${game[i].name}" class="image-game"></div>`
}
let com = '<h1 class="text-h1">COM</h1>'
for (let i = 0; i < game.length; i++) {
  com += `<div id="com-${game[i].name}-${game[i].id}" class="default-content"><img src="dien-ch4-assets/${game[i].image}" alt="${game[i].name}" class="image-game"></div>`
}
